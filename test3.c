...
int main()
{
    ...
    char filename[] = "<span class=\"skimlinks-unlinked\">plot.html</span>";
    ...
    fprintf(f, "<html><body><svg xmlns=\"<span class=\"skimlinks-unlinked\">http:/\/www.w3.org/TR/SVG</span>\" version=\"1.1\"");
